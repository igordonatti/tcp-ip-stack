...
/*
 * Procura por um espaço vazio na tabela cache ARP.
 * Quando encontra um, "preenche a vaga" com as informações
 * do pacote ARP que acabou de chegar (o IP e o MAC do remetente)
*/
